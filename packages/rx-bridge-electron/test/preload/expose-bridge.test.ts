...
/**
 * 연결 설정 축약(ADR 0013): `exposeBridgeInMainWorld`의 `contextBridge`·`ipcRenderer`·
 * `namespace`, `options` 자체를 생략했을 때의 기본값과 미주입 오류 경로.
 */
describe("exposeBridgeInMainWorld argument defaults", () => {
 ...
 */
describe("bindElectronBridge and exposeBridgeInMainWorld default channel parity", () => {
